...
test(`Test to learn CSS Selectors`, async ({ page }) => { 
  ...
  await page.locator(`//input[@name='Individual-search-input']`).fill("Balamurugan")
 ...
 await page.locator(`//*[@class='firstName compoundBorderBottom form-element__row input']`).fill("Mitran")
 await page.locator(`//*[@class='slds-button slds-button_neutral uiButton--brand uiButton forceActionButton']`).click(); 
 await expect.soft(page.locator(`(//span[@class='slds-grid slds-grid_align-spread'])[2]`)).toContainText("Mitran")
